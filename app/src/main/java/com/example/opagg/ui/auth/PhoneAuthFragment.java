package com.example.opagg.ui.auth;
...
import com.example.opagg.ui.addnew.DashboardFragment;
...
import com.example.opagg.databinding.FragmentPhoneAuthBinding;
...
public class PhoneAuthFragment extends Fragment {
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        View view = getParentFragment().getActivity().findViewById(R.id.nav_view);
        if (user == null) {
            // Signed out
